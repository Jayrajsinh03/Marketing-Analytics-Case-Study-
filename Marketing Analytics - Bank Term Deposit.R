## Marketing Analytics Case Study : Bank Term Deposit
...
path <- "C:/Users/Jordan/Documents/Data/bank_term_deposit_marketing_analysis.xlsx"
sheets <- excel_sheets(path)
sheets

# 2.0   INVESTIGATE DATA FROM EACH SHEET-----
